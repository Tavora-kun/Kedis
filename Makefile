...
SRCS = kvstore.c ntyco.c proactor.c src/engines/kvs_array.c src/engines/kvs_rbtree.c src/engines/kvs_hash.c src/engines/kvs_skiplist.c src/persistence/ksf.c src/persistence/aof.c replication.c memory_pool.c
